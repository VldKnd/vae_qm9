...
#parser.add_option("-v", "--val", dest="val_path")

parser.add_option("-c", "--vocab", dest="vocab_path")
...
for epoch in range(MAX_EPOCH):
    ...
    wloss, word_acc,topo_acc,assm_acc,steo_acc = 0,0,0,0,0
    ...
    for it, batch in enumerate(dataloader):
        try:
            ...
            if (it + 1) % PRINT_ITER == 0:
                ...
                print("Loss: %.3f, KL: %.1f, Word: %.2f, Topo: %.2f, Assm: %.2f, Steo: %.2f" % (wloss, kl_div, word_acc, topo_acc, assm_acc, steo_acc))
